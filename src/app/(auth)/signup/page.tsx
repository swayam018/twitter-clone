  ...
  return (
    <div className=' flex justify-center items-center min-h-screen h-full w-full bg-black'>
      ...
      <div className=' input'>
          ...
          <input type="text" placeholder='Enter fullname' className=' outline-none border border-white rounded-md bg-transparent px-2 py-2 w-full  focus:shadow-normal focus:shadow-white' required onChange={handleChange} value={formData.name} name='name'/>
        </div>
        <div className=' input'>
        ...
        <div className=' input'>
          <label htmlFor="Password">Username(Optional)</label>
          <input type="password" placeholder='Enter Username'  className=' outline-none border border-white rounded-md bg-transparent px-2 py-2 w-full focus:shadow-normal focus:shadow-white' onChange={handleChange} value={formData.username} name='username' /> 
        </div>
